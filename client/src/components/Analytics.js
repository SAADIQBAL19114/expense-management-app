...
const Analytics = ({ allTransection }) => {
  ...
  const totalIncomePercent =
    (totalIncomeTransection.length / totalTransections) * 100;
  const totalExpensePercent =
    (totalExpenseTransection.length / totalTransections) * 100;
  ...
  const totalExpenseTurnover = allTransection
    ...
    console.log ("total turnover", allTransection);
    console.log ("expensetiurnover", totalExpenseTurnover);
          ...
          <div className="col-md-4">
            <div className="card">
              <div className="card-header">
                Total Transactions = {totalTransections}
              </div>
